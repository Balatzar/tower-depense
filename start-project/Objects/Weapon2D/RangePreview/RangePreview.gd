...
func appear() -> void:
	...
	_tween.interpolate_property(
		self, "modulate", modulate, Color(1, 1, 1, 1), tween_duration, Tween.TRANS_LINEAR, Tween.EASE_OUT)
	_tween.start()
...
func disappear() -> void:
	...
	_tween.interpolate_property(
		self, "modulate", modulate, Color(1, 1, 1, 0), tween_duration * 2.0, Tween.TRANS_LINEAR, Tween.EASE_OUT)
	_tween.start()
